...
class NSDate_RFC3339Extention: XCTestCase {
    ...
    func testUserVisibleDateFromRFC3339DateTimeString()
    {
        ...
        let test1Date: Date? = Date.userVisibleDateFromRFC3339DateTimeString(test1String)
        ...
        let test2Date: Date? = Date.userVisibleDateFromRFC3339DateTimeString(test2String)
        ...
        let test3Date: Date? = Date.userVisibleDateFromRFC3339DateTimeString(test3String)
    ...
    func testUserVisibleDateTimeStringForRFC3339FromDate()
    {
        ...
        let test1String = "2002-10-02T10:00:00-05:00"
        let test1Date: Date? = Date.userVisibleDateFromRFC3339DateTimeString(test1String)
        let test1StringFromDate:String? = Date.userVisibleDateTimeStringForRFC3339FromDate(test1Date)
        ...
        let test2String = "2002-10-02T15:00:00Z"
        let test2Date: Date? = Date.userVisibleDateFromRFC3339DateTimeString(test2String)
        let test2StringFromDate:String? = Date.userVisibleDateTimeStringForRFC3339FromDate(test2Date)
        ...
        let test3String = "2002-10-02T15:00:00.05Z"
        let test3Date: Date? = Date.userVisibleDateFromRFC3339DateTimeString(test3String)
        let test3StringFromDate:String? = Date.userVisibleDateTimeStringForRFC3339FromDate(test3Date)
        ...
        let test4String = Date.userVisibleStringForRFC3339FromCurrentDate()
        let test4Date: Date? = Date.userVisibleDateFromRFC3339DateTimeString(test4String)
        let test4StringFromDate:String? = Date.userVisibleDateTimeStringForRFC3339FromDate(test4Date)
